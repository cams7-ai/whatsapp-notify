"""Teste unitário exemplo da camada de serviço.
...
class TestNotificationService:
    ...
    def service(self, mock_repository, mock_logger):
        """Cria instância do serviço com dependências mockadas."""
...
class TestNotification:
    ...
    def test_notification_creation_with_valid_data(self):
        """Testa criação válida de notificação."""
